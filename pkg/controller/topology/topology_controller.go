...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &tarantoolv1alpha1.Topology{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &tarantoolv1alpha1.Topology{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileTopology) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &tarantoolv1alpha1.Topology{}
