    ...
    run_tests_console(
        ...
        if cfg.bench {
            ...
            tests![
                ...
                test_fiber::channel_send_self,
                test_fiber::channel_send_full,
                test_fiber::channel_recv_empty,
                test_fiber::channel_drop_sender,
                test_fiber::channel_dont_drop_msg,
                test_fiber::channel_unbuffered,
                test_fiber::channel_1v2,
                test_fiber::channel_2v1,
                test_fiber::channel_drop,
                test_fiber::channel_circle,
                test_fiber::channel_as_mutex,
                test_fiber::channel_iter,
                test_fiber::channel_into_iter,
                test_fiber::channel_try_iter,
