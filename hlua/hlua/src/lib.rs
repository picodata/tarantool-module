...
/// Types implementing this trait represent multiple return values on the stack.
///
/// This trait is **unsafe** because it's implementation must be correct with
/// respect to `LuaRead` implementation.
pub unsafe trait ReturnCount {
    /// Number of return values expected for this type.
    const RETURN_COUNT: u32;
}
